...
def create_dataset(data_config: _config.DataConfig, model_config: _model.BaseModelConfig) -> Dataset:
    ...
    #allow mutli datasets or single datasets for finetune
    if isinstance(repo_id,str):
        ...
        dataset_meta = lerobot_dataset.LeRobotDatasetMetadata(repo_id[0], local_files_only=data_config.local_files_only)
        ...
        assert True, f"repo_id type is not supported,only str and list."
